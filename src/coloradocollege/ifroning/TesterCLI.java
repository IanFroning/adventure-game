...
/**
 * Tests the project without using the GUI.
 * @author Ian Froning
 * @version 1.0
 */
public class TesterCLI
{
	...
	{		
		...
		System.out.println(player.getInventory().pickUp(eatme));// pick up eatme
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.getInventory().use(eatme, new Activator(), player));// use eatme
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.move("N")); // move north
		System.out.println(player.getInventory().pickUp(bigStick));// pick up bigStick
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.getInventory().use(bigStick, panamaCanal, player));// use bigStick on panama canal
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.getInventory().use(bigStick, panamaCanal, player));// use bigStick on panama canal
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.move("U")); // move up
		System.out.println(player.move("N")); // move north
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.getInventory().use(bigStick, panamaCanal, player));// use bigStick on panama canal
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
		System.out.println(player.getInventory().drop(bigStick));// drop bigStick
		System.out.println(player.getLocation().getDescription());
		System.out.println(player.getInventory().getDescription());
